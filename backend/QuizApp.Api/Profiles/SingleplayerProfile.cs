...
public sealed class SingleplayerProfile : Profile
{
    public SingleplayerProfile()
    {
        ...
        CreateMap<Level, LevelDto>()
            ...
            .ForMember(dest => dest.FirstCompletionExperience, opt => opt.MapFrom(src => src.FirstCompletionExperience))
            .ForMember(dest => dest.ReplayExperience, opt => opt.MapFrom(src => src.ReplayExperience))
